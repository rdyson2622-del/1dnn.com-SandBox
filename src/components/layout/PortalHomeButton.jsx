...
export default function PortalHomeButton({ onClick, label }) {
  return (
    <button
      onClick={onClick}
      className="min-w-11 min-h-11 md:min-w-0 md:min-h-0 flex items-center justify-center gap-2 text-xs font-black tracking-[0.12em] px-3 py-2 rounded-lg transition-all hover:opacity-80"
